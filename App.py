...
def upload_and_analyze():
    ...
    neg_comments = data["Negative Comments"].dropna().unique().tolist()
       # Combine positive and negative comments with labels
    comments = pos_comments + neg_comments
    labels = ['Positive'] * len(pos_comments) + ['Negative'] * len(neg_comments)
    ...
    if  vader_sentiment == 'Positive' and textblob_sentiment >= 0:
        result = "Positive"
    else:
        result = "Negative"
